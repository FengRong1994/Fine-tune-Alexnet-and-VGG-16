...
with tf.Session() as sess:
  ...
  saver.restore(sess,"/Users/rongfeng/Downloads/finetune_alexnet/model_epoch_321layers73.ckpt")
  ...
  for epoch in range(num_epochs):
        ...
        checkpoint_name = os.path.join(checkpoint_path, 'model_epoch_321layers'+str(epoch+1)+'.ckpt')
